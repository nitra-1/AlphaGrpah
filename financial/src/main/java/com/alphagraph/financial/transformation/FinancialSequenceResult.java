 ...
 * genuine silence never produces a result at all, distinct from {@link FinancialSequenceReadinessResult},
 * which is always computed.
 */
record FinancialSequenceResult(
    UUID instrumentId, String symbol, LocalDate asOfDate,
    FinancialSequenceType sequenceType, FinancialSequencePhase sequencePhase,
