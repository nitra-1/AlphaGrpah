...
class OrderBookLedgerParserTest {
    ...
    private final OrderBookLedgerParser parser = new OrderBookLedgerParser();
    ...
    void parsesFullOrderFactsIntoAnEntry() {
        ...
        assertThat(entry.customer()).isEqualTo("Ministry of Defence");
    ...
    void missingOptionalFactsLeaveTheEntryFieldsNull() {
        ...
        assertThat(entry.customer()).isNull();
