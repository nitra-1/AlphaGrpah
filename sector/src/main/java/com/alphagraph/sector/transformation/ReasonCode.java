 ...
 * {@code market.transformation.ReasonCode}/{@code financial.transformation.ReasonCode}/
 * {@code corporate.transformation.ReasonCode} (same shape) - domain packages never share a type
 * across module-internal boundaries in this codebase.
 */
