...
/**
 * Loads the 4 named Stage 3 Sector sequence thresholds from
 ...
 */
@Component
class SectorSequenceRuleSetLoader {

    private static final List<String> RULE_NAMES = List.of(
        "stage3-sector-tailwind-max-gap", "stage3-leadership-emergence-max-gap",
        "stage3-sector-sequence-max-age", "stage3-sector-contrast-max-evidence-lag"
    );

    private final JdbcTemplate jdbcTemplate;

    SectorSequenceRuleSetLoader(JdbcTemplate jdbcTemplate) {
