 ...
 * with null materiality fields rather than being hidden.
 */
@Component
    ...
    public List<DiscoveredDealDetail> findDealsForSymbol(String symbol) {
        return jdbcTemplate.query(
            ...
            SELECT d.id, d.deal_date, d.client_name, d.buy_sell, d.quantity, d.price, d.deal_value, d.deal_type,
                   m.materiality_score, m.materiality_level, m.deal_to_adtv_ratio, m.reported_flow_state
            ...
            (rs, rowNum) -> new DiscoveredDealDetail(
                ...
                rs.getString("deal_type"), toDouble(rs.getBigDecimal("materiality_score")), rs.getString("materiality_level"),
