...
/**
 * Loads the 16 named Stage 4 convergence thresholds from {@code common.rule_definitions}/
 ...
 */
@Component
class DiscoveryConvergenceRuleSetLoader {

    private static final List<String> RULE_NAMES = List.of(
        "stage4-min-domains-early-convergence", "stage4-min-domains-multidomain",
        "stage4-strong-convergence-score-threshold", "stage4-multidomain-score-threshold",
        "stage4-convergence-max-span-days",
        "stage4-market-max-age-days", "stage4-sector-max-age-days",
        "stage4-financial-max-age-days", "stage4-ownership-max-age-days", "stage4-capital-max-age-days",
        "stage4-max-contradiction-penalty", "stage4-risk-contradiction-max-age-days",
        "stage4-weight-breadth", "stage4-weight-maturity", "stage4-weight-recency",
        "stage4-weight-confidence", "stage4-weight-density"
    );

    private final JdbcTemplate jdbcTemplate;

    DiscoveryConvergenceRuleSetLoader(JdbcTemplate jdbcTemplate) {
