...
Next: Module 1.6+ - the remaining Phase 1 engines (Fundamental/Institutional/Sector/Risk), all currently empty module scaffolds. The intelligence-bridges-domain-modules pattern established in 1.5 (published read interface + orchestrator in intelligence) is the template each of these will likely follow.
