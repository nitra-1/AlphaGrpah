...
Next: Module 2.2 - not yet scoped; likely either a second document source reusing the Document Pipeline framework, or the first Corporate Intelligence engine (Corporate Event/Order Book/Management Commentary/News) consuming Module 2.1's chunks/entities.
