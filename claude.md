...
Next: Module 2.9 - AI Analyst (explicitly "explains, never calculates" - reasons only over structured signals like Corporate Score and the Module 2.7 knowledge graph, never raw documents), then 2.10 (Dashboard).
