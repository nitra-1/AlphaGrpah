...
Next: Module 2.5 - not yet scoped; likely the third Corporate Intelligence engine (Management Commentary or News Intelligence) as a rule engine over Module 2.2's canonical facts/topics, or broadening Module 2.1's Exchange Announcements source to the other 5 named Phase 2 sources.
